<template>
    <div class="centermap">
        ...
        <div class="centerimg">
            ...
            <div class="info">
                <div><span class="title">开关位置</span><span>源1</span></div>
                <div><span class="title">手自动状态</span><span>自动</span></div>
            </div>
        </div>
        <div>
            <div class="table-box">
