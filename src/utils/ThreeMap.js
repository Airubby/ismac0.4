...
import cabinet from '@/assets/images/hvdc.png';
import air from '@/assets/images/lietougui.png';
...
export default class ThreeMap {
    ...
    mouseMousemoveEvent(event){
       for(let i=0;i< this.group.children.length;i++) {
            ...
            if(div!=null){
                ...
                let posi=new THREE.Vector3(this.group.children[i].position.x,(this.group.children[i].position.y)*2,this.group.children[i].position.z-(1.66/2));
    ...
    updatevalue(uuiddata,value){
        ...
        var y= obj.position.y;
        obj.position.y=y-1.66*(1-value/100)/2;
