    ...
    <div class="content">
        <div id="centermap" class="centermap">
            ...
            <map name="map" id="map">
                ...
                <el-popover
                    class="mapshow" coords="20,150,845,465"
                    placement="top"
                    width="260"
                    trigger="hover">
                    <div slot="reference" coords="20,150,845,465" class="maparea openair"></div>
                    <div class="mapcon loncom_index_publicbox">
                        echart取的测点信息是有功功率这个测点的值
                    </div>
                </el-popover>
            </map>
        </div>
...
export default {
    ...
    created() {
        for(let i=1;i<7;i++){
            this.$set(this.initParams,"p"+i,{key:"p"+i,devid:"",pointid:"",format:"",showName:"",value:""})
        }
    },
    mounted() {
...
        }  
    ...
    data(){
        return{
            ...
            //竖着排序
            coords:[
                "20,30,110,130","150,30,240,130","280,30,405,130","455,30,545,130","590,30,670,130","735,30,835,130"
            ],
            initParams:{}
        }
    },
