<template>
    <el-dialog title='设备分类' :visible.sync="dialogInfo.visible" width="900px" v-dialogDrag :close-on-click-modal="false" :append-to-body="true">
        ...
        <add-type v-if="addInfo.visible" :dialogInfo="addInfo"></add-type>
    </el-dialog>
</template>
